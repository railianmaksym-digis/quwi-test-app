...
import com.digis.quwi.test.app.projects.users.UsersActivity;
import com.digis.quwi.test.app.utils.ActionListener;
import com.digis.quwi.test.databinding.ActivityProjectListBinding;
...
public class ProjectListActivity extends BaseActivity<ProjectListViewModel, ActivityProjectListBinding> {
    ...
    private void setupViewModel() {
        ...
        viewModel.openChangeProjectNameDialog.observe(this, project -> {
            ChangeProjectNameDialogFragment.create(
                    project.getName(),
                    newName -> viewModel.changeProjectName(project.getId(), newName))
